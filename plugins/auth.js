...
//     const resp = await ctx.$adminApi.auth.loginWithSocial({ access_token: accessToken }, strategy)
...
//     await ctx.$auth.setUserToken(resp.data.access_token, resp.data.refresh_token)
//   } catch {
