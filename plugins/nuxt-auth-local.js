...
//   // Call API location
//   $auth.onRedirect((to) => {
//     if ($auth.loggedIn) $adminInstance.defaults.headers.common.Authorization = $auth.strategy.token.get()
...
//   $adminInstance.defaults.headers.common.Authorization = $auth.strategy.token.get()
// }
